...
#test skopeo
docker exec -it $IMAGE_NAME skopeo --tmpdir=/root/tmp inspect docker://ubuntu:21.04
docker exec -it $IMAGE_NAME skopeo --tmpdir=/root/tmp inspect docker-daemon:$IMAGE_NAME
